...
//        });
    ...
    private void refreshCards() {
        ...
        handCards.add(refreshCard);
        if(cardListAdapter != null) {
            cardListAdapter.setOptions(handCards);
        }
    }
...
//        // Make sure to set it after dismiss, otherwise if "refresh" is clicked
//        // the menu pops up in the wrong spot
//        isRefreshing = false;
//        fab.setRotation(0f);
...
//                // Make sure to rotate it back when the popup is closed
//                // if it's not being refreshed
//                if(!isRefreshing) {
...
//                MenuItem thisItem = cardMenu.add(curCard
//                        .getCardText().replace("%s", "______"));
...
//    }
    ...
    private void populateCards() {
        FirebaseResourceManager.loadCardsFromPack("InitialPack",
