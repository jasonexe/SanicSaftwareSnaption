...
public class GameTest {
    ...
    public void verifyTimeRemaining() {
        ...
        game1 = new Game(data1, gameMetadata1);
        assertEquals("1 minute remaining", game1.remainingTime(0));
        end = 40;
        gameMetadata1 = new GameMetadata("1", "a", imagePath, tags1, true, end, start, 1.0);
        game1 = new Game(data1, gameMetadata1);
        assertEquals("0 minutes remaining", game1.remainingTime(0));
        end = 3599;
        gameMetadata1 = new GameMetadata("1", "a", imagePath, tags1, true, end, start, 1.0);
        game1 = new Game(data1, gameMetadata1);
        assertEquals("59 minutes remaining", game1.remainingTime(0));
        end = 3598;
        gameMetadata1 = new GameMetadata("1", "a", imagePath, tags1, true, end, start, 1.0);
        game1 = new Game(data1, gameMetadata1);
        assertEquals("59 minutes remaining", game1.remainingTime(0));
        ...
        gameMetadata1 = new GameMetadata("1", "a", imagePath, tags1, true, end, start, 1.0);
        game1 = new Game(data1, gameMetadata1);
        assertEquals("50 minutes remaining", game1.remainingTime(0));
        end = 3600;
        gameMetadata1 = new GameMetadata("1", "a", imagePath, tags1, true, end, start, 1.0);
        game1 = new Game(data1, gameMetadata1);
        assertEquals("1 hour remaining", game1.remainingTime(0));
        end = 3660;
        gameMetadata1 = new GameMetadata("1", "a", imagePath, tags1, true, end, start, 1.0);
        game1 = new Game(data1, gameMetadata1);
        assertEquals("1 hour remaining", game1.remainingTime(0));
        ...
        gameMetadata1 = new GameMetadata("1", "a", imagePath, tags1, true, end, start, 1.0);
        game1 = new Game(data1, gameMetadata1);
        assertEquals("23 hours remaining", game1.remainingTime(0));
        end = 72000;
        gameMetadata1 = new GameMetadata("1", "a", imagePath, tags1, true, end, start, 1.0);
        game1 = new Game(data1, gameMetadata1);
        assertEquals("20 hours remaining", game1.remainingTime(0));
        end = 86400;
        gameMetadata1 = new GameMetadata("1", "a", imagePath, tags1, true, end, start, 1.0);
        game1 = new Game(data1, gameMetadata1);
        assertEquals("1 day remaining", game1.remainingTime(0));
        end = 86440;
        gameMetadata1 = new GameMetadata("1", "a", imagePath, tags1, true, end, start, 1.0);
        game1 = new Game(data1, gameMetadata1);
        assertEquals("1 day remaining", game1.remainingTime(0));
        ...
        gameMetadata1 = new GameMetadata("1", "a", imagePath, tags1, true, end, start, 1.0);
        game1 = new Game(data1, gameMetadata1);
        assertEquals("50 days remaining", game1.remainingTime(0));
    }
}