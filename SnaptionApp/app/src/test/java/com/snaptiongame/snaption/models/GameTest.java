...
public class GameTest {
    ...
    public void verifyConstructors() {
        ...
        long end = 1000;
        long start = 500;
        Game game = new Game("me", "you", "images/", players, categories, true, end, "G", 1);
        Game game1 = new Game("me", "you", "images/", players, categories, true, end, start, "G", 1);
    ...
    public void verifyAddCaption() {
        ...
        long end = 1000;
        long start = 500;
        Game game = new Game("me", "you", "images/", players, categories, true, end, start, "G", 1);
